...
root.iconbitmap("C:/Users/ADMIN/OneDrive/OneDrive - VietNam National University - HCM INTERNATIONAL UNIVERSITY/Desktop/Data Science/Linear Algebra\Matrix-Calculator/matrix.ico")  
root.title("Anh Manh sieu dep trai")               
...
# Label matriks A
mA = Label(f1, font = ("arial", "9", "bold"), text = "Matrix A", bg = "#474E64", fg = "#FFFFFF")
mA.grid(row = 0, column = 0, columnspan = 2, pady = 4)

# Label matriks B
mB = Label(f1, font = ("arial", "9", "bold"), text = "Matrix B", bg = "#474E64", fg = "#FFFFFF")
...
rA = Label(f1, text = "Rows   ", bg = "#474E64", fg = "#FFFFFF"); rA.grid(row = 1, column = 0)
# Entry baris (matriks A)
eRA = Entry(f1, width = 5, justify = "center", relief = SUNKEN, bd = 3); eRA.grid(row = 1, column = 1)

# label baris (matriks B)
rB = Label(f1, text = "Rows   ", bg = "#474E64", fg = "#FFFFFF"); rB.grid(row = 1, column = 2, padx = (40, 0))
...
cA = Label(f1, text = "Columns", bg = "#474E64", fg = "#FFFFFF"); cA.grid(row = 2, column = 0)
# Entry kolom (matriks A)
eCA = Entry(f1, width = 5, justify = "center", relief = SUNKEN, bd = 3); eCA.grid(row = 2, column = 1)

# label kolom (matriks B)
cB = Label(f1, text = "Columns", bg = "#474E64", fg = "#FFFFFF"); cB.grid(row = 2, column = 2, padx = (40, 0))
